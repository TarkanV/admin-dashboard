const projects = [
    {
      title: "The Super-Duper Hyper-Quantum Thingamajig",
    ...
    {
      title: "The Interdimensional Portal Generator... or Not",
    ...
    {
      title: "The Neutrino Accelerator Particle Thingy",
    ...
    {
      title: "The Electro-Quantum-Hyper-Thingamabob",
  ...
  function User(name, tag, pic="img/placeholder.png"){
    this.name = name;
    this.tag = tag;
    this.pic = pic;
  }
